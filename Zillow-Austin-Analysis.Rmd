...
```{r bootstrap mean Broker sale, echo = F, eval = T}
...
```{r hist of bootstrap means, echo = F, fig.height=4, fig.width=5}
...
```{r boot distn of median, echo = F, fig.height=4, fig.width=5}
...
```{r bootstrapping stats on New Construction, echo = F}
################## Bootstrap percentile technique #####################
#######################################################################
...
The median is highly skewed, the interval estimate from the 95% CI has an enormous range, and the bias percentage is approximately 50% (.4786609), so this sample does not seem representative of the true population of newly constructed house prices.

Could perform hypothesis test on 600k median claim from google.
