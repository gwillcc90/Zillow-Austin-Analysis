...
graphics::hist(boot.meds, main = 'Bootstrap Distribution of Medians', xlab = 'Medians')
```
...
How does this compare to newly constructed houses? We saw that the average price for newly constructed housing units was approximately double that of ones for sale by a broker. Let's get some metrics on newly constructed house listings.
