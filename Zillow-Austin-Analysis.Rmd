...
Given the data, we fail to reject the null hypothesis at any small level of significance and say that *there is not statistically significant evidence to contradict the claim that the median house price is more than 600k.*

So, we're fairly certain we could find some options under 600k. Austin seems like "the spot", though, so we may be willing to dish out the cash for a "spot at the spot".
